	...
	<center>
		...
		<form method="post" action="http://localhost:8080/BTS/Ajout_File" enctype="multipart/form-data">
			<table border="3">
				...
				<tr>
					<td> </td>
					<td><input class="text" required="required" type="hidden" name="lastName" style="width: 94%" placeholder="saisissez le nom du fichier"/></td>
				</tr>
				<tr>
					<td>Votre fichier: </td>
					<td><input class="text" required="required" type="file" name="contenent" style="width: 94%" placeholder="saisissez votre fichier"/></td>
				</tr>
				<tr>
					<td colspan="10">
						<input type="submit" value="Envoyer" style="width: 60%">
					</td>
				</tr>
			</table>
		</form>
